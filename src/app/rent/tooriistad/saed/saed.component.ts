...
@Component({
  selector: 'app-saed',
  templateUrl: './saed.component.html',
  styleUrls: ['./saed.component.css']
})
export class SaedComponent implements OnInit {
  
  saed: {id: number, name: string, price: number, description: string, category: string, imgSrc: string, isActive: boolean}[] = [];
  products: Product[] = [];
  rentProductsUrl = "https://t88riistarent-default-rtdb.europe-west1.firebasedatabase.app/rentproducts.json"
  dbUrl = "https://t88riistarent-default-rtdb.europe-west1.firebasedatabase.app/saed.json";
